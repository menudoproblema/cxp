    ...
    CapabilityCatalog(
        ...
        capabilities=(
            ...
            CatalogCapability(
                ...
                telemetry=_mongodb_operation_telemetry(
                    span_name="db.client.transaction",
                    metric_name="db.client.transaction.duration",
                    event_type="db.client.transaction.completed",
                    extra_span_attributes=(_DB_TRANSACTION_ID_FIELD,),
                    extra_metric_labels=(_DB_TRANSACTION_OUTCOME_FIELD,),
                    extra_event_payload_keys=(
                        _DB_TRANSACTION_ID_FIELD,
                        _DB_TRANSACTION_OUTCOME_FIELD,
                    ),
                    description="Transaction orchestration span.",
                ),
            ),
            CatalogCapability(
                ...
                telemetry=_mongodb_operation_telemetry(
                    span_name="db.client.change_stream",
                    metric_name="db.client.change_stream.duration",
                    event_type="db.client.change_stream.completed",
                    extra_span_attributes=(_DB_CHANGE_OPERATION_TYPE_FIELD,),
                    extra_metric_labels=(_DB_CHANGE_OPERATION_TYPE_FIELD,),
                    extra_event_payload_keys=(_DB_CHANGE_OPERATION_TYPE_FIELD,),
                    description="Change-stream observation span.",
                ),
            ),
            CatalogCapability(
            ...
            CatalogCapability(
                ...
                telemetry=_mongodb_operation_telemetry(
                    span_name="db.client.collation",
                    metric_name="db.client.collation.duration",
                    event_type="db.client.collation.completed",
                    extra_span_attributes=(_DB_COLLATION_LOCALE_FIELD,),
                    extra_metric_labels=(_DB_COLLATION_LOCALE_FIELD,),
                    extra_event_payload_keys=(_DB_COLLATION_LOCALE_FIELD,),
                    description="Collation-aware database operation span.",
                ),
            ),
            CatalogCapability(
                ...
                telemetry=_mongodb_operation_telemetry(
                    span_name="db.client.persistence",
                    metric_name="db.client.persistence.duration",
                    event_type="db.client.persistence.reported",
                    extra_span_attributes=(
                        _DB_PERSISTENCE_ENGINE_FIELD,
                        _DB_PERSISTENCE_PERSISTENT_FIELD,
                    ),
                    extra_metric_labels=(_DB_PERSISTENCE_ENGINE_FIELD,),
                    extra_event_payload_keys=(
                        _DB_PERSISTENCE_ENGINE_FIELD,
                        _DB_PERSISTENCE_PERSISTENT_FIELD,
                    ),
                    description="Persistence metadata reporting span.",
                ),
            ),
            CatalogCapability(
        ...
        tiers=(
            ConformanceTier(
                ...
                description=(
                    "Core MongoDB interoperability with read, write, and "
                    "aggregation support."
                ),
            ),
            ConformanceTier(
                ...
                description="MongoDB provider with Atlas Search and vector search.",
            ),
            ConformanceTier(
                ...
                description="MongoDB provider exposing a broader platform surface.",
            ),
        ),
    )
)
